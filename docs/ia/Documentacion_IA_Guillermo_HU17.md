...
| Estado de migraciones | Sin cambios de modelo sin migración; `tasas.0002` pendiente de aplicación en desarrollo |
...
tasas/migrations/0002_consultaproveedortasas_tasareferencia.py
