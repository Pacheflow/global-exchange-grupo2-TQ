...
`-- migrations/0002_consultaproveedortasas_tasareferencia.py   Esquema incremental
```
...
La migración incremental incorporada es `tasas/migrations/0002_consultaproveedortasas_tasareferencia.py`; la migración `0001_initial.py` existente permanece intacta.
