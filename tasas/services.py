...
class ResultadoConsultaTasas:
    """Resultado de una consulta de tasas de referencia."""
...
def _tasas_guardadas(moneda_base):
    """Obtiene las últimas tasas de referencia guardadas para una base."""
...
def consultar_tasas_referencia(*, proveedor=None):
    """Actualiza las tasas externas o devuelve el último dato válido."""
