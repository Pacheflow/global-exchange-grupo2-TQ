# Generated by Django 6.1 on 2026-09-06 15:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('valor', models.DecimalField(decimal_places=10, max_digits=24, validators=[django.core.validators.MinValueValidator(Decimal('1E-10'))])),
                ('fuente', models.CharField(max_length=100)),
                ('fecha_hora_fuente', models.DateTimeField()),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('moneda_base', 'moneda_cotizada'), name='tasa_referencia_par_unico'), models.CheckConstraint(condition=models.Q(('moneda_base', models.F('moneda_cotizada')), _negated=True), name='tasa_referencia_monedas_distintas'), models.CheckConstraint(condition=models.Q(('valor__gt', 0)), name='tasa_referencia_valor_positivo')],
            },
        ),
    ]
