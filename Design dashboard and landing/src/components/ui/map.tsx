...
import { Compass, X, Minus, Plus, Locate, MapPin, Maximize, Loader2 } from "lucide-react";
...
function DefaultMarkerIcon() {
  return <MapPin className="size-5 text-blue-500 drop-shadow" strokeWidth={1.8} />;
}
        ...
        <ControlGroup>
          ...
          >
            {waitingForLocation ? (
              ...
              <Locate className="size-4" strokeWidth={1.8} />
            )}
          </ControlButton>
        </ControlGroup>
      )}
