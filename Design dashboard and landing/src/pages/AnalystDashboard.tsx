...
const sidebarItems = [
  { icon: <AppIcon name="dashboard" />, label: 'Resumen', href: '/analyst' },
  { icon: <AppIcon name="chart" />, label: 'Tasas', href: '/analyst/tasas' },
  { icon: <AppIcon name="history" />, label: 'Histórico', href: '/analyst/historico' },
  { icon: <AppIcon name="earnings" />, label: 'Ganancias', href: '/analyst/ganancias' },
  { icon: <AppIcon name="reports" />, label: 'Reportes', href: '/analyst/reportes' },
  { icon: <AppIcon name="bell" />, label: 'Notificaciones', href: '/analyst/notificaciones', badge: 1 },
];
        ...
        <main style={{ flex: 1, padding: '80px 0 0', overflowX: 'hidden' }}>
          ...
          <div style={{ padding: '28px 40px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14, marginBottom: 28 }}>
              {[
                { label: 'USD/PYG COMPRA', value: '7.480', sub: '+31 vs. ayer', color: 'var(--success)', trend: 'up' as const },
                { label: 'EUR/PYG COMPRA', value: '8.120', sub: '-15 vs. ayer', color: 'var(--danger)', trend: 'down' as const },
                ...
                <div key={k.label} className="ge-card" style={{ padding: '20px 24px' }}>
                  ...
                  <div style={{ fontSize: 11, color: 'var(--text-3)', fontFamily: 'DM Sans', marginTop: 6, display: 'flex', alignItems: 'center', gap: 4 }}>
                    {'trend' in k && k.trend && <AppIcon name={k.trend} size={12} />}{k.sub}
                  </div>
                </div>
              ))}
            </div>
            ...
            {saved && (
              <div style={{
                ...
                <AppIcon name="check" size={18} /> Tasa {saved}/PYG actualizada exitosamente
              </div>
            )}
