...
const sidebarItems = [
  { icon: <AppIcon name="dashboard" />, label: 'Resumen', href: '/cashier' },
  { icon: <AppIcon name="vault" />, label: 'Mi caja', href: '/cashier/caja' },
  { icon: <AppIcon name="briefcase" />, label: 'Saldos', href: '/cashier/saldos' },
  { icon: <AppIcon name="movements" />, label: 'Movimientos', href: '/cashier/movimientos' },
  { icon: <AppIcon name="exchange" />, label: 'Transferencias', href: '/cashier/transferencias' },
  { icon: <AppIcon name="scale" />, label: 'Arqueo', href: '/cashier/arqueo' },
  { icon: <AppIcon name="history" />, label: 'Historial', href: '/cashier/historial' },
];
  ...
  return (
    <div className="ge-card" style={{ padding: '20px 22px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
        <CurrencyIcon code={currency} size={22} />
        <span style={{
                  ...
                  {cashierData.balances.map(b => (
                    <div key={b.currency} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12, alignItems: 'center', marginBottom: 14 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <CurrencyIcon code={b.currency} size={18} />
