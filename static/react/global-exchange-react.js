...
var m = { IntegrationProbe: p };
function h(e) {
	return m[e];
}
//#endregion
//#region src/django-entry.tsx
var g = "[data-react-component]";
function _(e) {
	let t = e.dataset.reactPropsId, n = t ? document.getElementById(t)?.textContent : void 0;
	if (!n) return {};
	let r = JSON.parse(n);
	if (typeof r != "object" || !r || Array.isArray(r)) throw TypeError("Las propiedades de una isla React deben ser un objeto JSON.");
	return r;
}
function v(e) {
	if (e.dataset.reactMounted === "true") return;
	let t = e.dataset.reactComponent, n = t ? h(t) : void 0;
	if (!n) {
...
function y() {
	document.querySelectorAll(g).forEach(v);
}
